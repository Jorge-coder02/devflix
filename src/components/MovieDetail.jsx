...
function MovieDetail() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${id}?api_key=04763e54a6cd6b839a62c81f39341789`,
        options
      )
      .then((response) => {
    ...
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${id}/videos?api_key=04763e54a6cd6b839a62c81f39341789`,
        options
      )
      .then((response) => {
